  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute -right-3 top-16 z-10 w-6 h-6 rounded-full bg-card border border-border shadow-md flex items-center justify-center text-muted-foreground hover:text-foreground transition-colors"
      >
    ...
    <div className="fixed inset-0 z-50 md:hidden flex">
      ...
      <aside className="relative z-50 w-72 max-w-[85vw] bg-card border-r border-border h-full flex flex-col shadow-2xl animate-slide-in-left">
        ...
        <div className="p-4 border-t border-border space-y-2">
          ...
          <button
            onClick={handleLogout}
            className="sidebar-item w-full py-3 text-destructive hover:bg-destructive/10 hover:text-destructive flex items-center gap-3 justify-center"
          >
